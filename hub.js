...
export function renderEcosystemHub(currentUser, onSelectApp) {
  ...
  // ВАЖЛИВО: рендеримо у ВЛАСНИЙ контейнер #page-hub,
  // а НЕ в #app-wrapper — інакше знищаться всі інші сторінки (page-main, page-shop і т.д.),
  // які лежать всередині app-wrapper, і навігація після цього зламається.
