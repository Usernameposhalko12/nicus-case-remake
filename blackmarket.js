...
function injectBlackMarketStyles() {
  ...
  s.textContent = `
    ...
    /* Сама відмичка — тепер їздить над пружинами вздовж пунктирної лінії,
       синхронно з рейкою внизу і зі стрілками/тапами. */
    .bm-tool-slider {
      position: absolute;
      top: 4px;
      bottom: 16px;
    ...
    const html = `
      ...
      <div class="bm-lock-wrap">
        ...
        <div class="bm-housing">
          ...
          <div class="bm-tool-slider" style="left:${toolLeft(cursor)}px;">
            <div class="bm-tool-arm"></div>
            <div class="bm-tool-hook"></div>
          </div>
          <div class="bm-pins">
