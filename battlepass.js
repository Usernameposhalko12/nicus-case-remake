...
export const BP_NORMAL_REWARDS = [
  // Кожен рядок: { level, type: "coins"|"case"|"lbk"|"medal", ... }
  { level: 1,  type: "coins",  amount: 50,          label: "50 💰" },
  { level: 2,  type: "lbk",   amount: 200,          label: "200 ЛБК" },
  { level: 3,  type: "case",   caseId: "summer26box", label: "Літо26 Бокс" },
  { level: 4,  type: "lbk",   amount: 200,          label: "200 ЛБК" },
  { level: 5,  type: "coins",  amount: 100,          label: "100 💰" },
  { level: 6,  type: "lbk",   amount: 300,          label: "300 ЛБК" },
  { level: 7,  type: "case",   caseId: "summer26box", label: "Літо26 Бокс" },
  { level: 8,  type: "lbk",   amount: 300,          label: "300 ЛБК" },
  { level: 9,  type: "coins",  amount: 150,          label: "150 💰" },
  { level: 10, type: "wheel",                        label: "🎡 Колесо!" },

  { level: 11, type: "lbk",   amount: 400,          label: "400 ЛБК" },
  { level: 12, type: "case",   caseId: "summer26",  label: "Літо26" },
  { level: 13, type: "coins",  amount: 200,          label: "200 💰" },
  { level: 14, type: "lbk",   amount: 400,          label: "400 ЛБК" },
  { level: 15, type: "case",   caseId: "summer26",  label: "Літо26" },
  { level: 16, type: "lbk",   amount: 500,          label: "500 ЛБК" },
  { level: 17, type: "coins",  amount: 250,          label: "250 💰" },
  { level: 18, type: "case",   caseId: "summerheat", label: "ЛітняСпека" },
  { level: 19, type: "lbk",   amount: 500,          label: "500 ЛБК" },
  { level: 20, type: "wheel",                        label: "🎡 Колесо!" },

  { level: 21, type: "coins",  amount: 300,          label: "300 💰" },
  { level: 22, type: "lbk",   amount: 600,          label: "600 ЛБК" },
  { level: 23, type: "case",   caseId: "summerheat", label: "ЛітняСпека" },
  { level: 24, type: "lbk",   amount: 600,          label: "600 ЛБК" },
  { level: 25, type: "coins",  amount: 400,          label: "400 💰" },
  { level: 26, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },
  { level: 27, type: "lbk",   amount: 700,          label: "700 ЛБК" },
  { level: 28, type: "coins",  amount: 400,          label: "400 💰" },
  { level: 29, type: "lbk",   amount: 700,          label: "700 ЛБК" },
  { level: 30, type: "wheel",                        label: "🎡 Колесо!" },

  { level: 31, type: "case",   caseId: "summerheat", label: "ЛітняСпека" },
  { level: 32, type: "lbk",   amount: 800,          label: "800 ЛБК" },
  { level: 33, type: "coins",  amount: 500,          label: "500 💰" },
  { level: 34, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },
  { level: 35, type: "lbk",   amount: 1000,         label: "1000 ЛБК" },
  { level: 36, type: "coins",  amount: 600,          label: "600 💰" },
  { level: 37, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 38, type: "lbk",   amount: 1000,         label: "1000 ЛБК" },
  { level: 39, type: "coins",  amount: 700,          label: "700 💰" },
  { level: 40, type: "wheel",                        label: "🎡 Колесо!" },

  { level: 41, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 42, type: "lbk",   amount: 1200,         label: "1200 ЛБК" },
  { level: 43, type: "coins",  amount: 800,          label: "800 💰" },
  { level: 44, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 45, type: "lbk",   amount: 1500,         label: "1500 ЛБК" },
  { level: 46, type: "coins",  amount: 900,          label: "900 💰" },
  { level: 47, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },
  { level: 48, type: "lbk",   amount: 2000,         label: "2000 ЛБК" },
  { level: 49, type: "coins",  amount: 1000,         label: "1000 💰" },
...
// ── НАГОРОДИ ПРАЙМ ТРЕКУ (50 рівнів) ──

export const BP_PRIME_REWARDS = [
  { level: 1,  type: "coins",  amount: 150,          label: "150 💰 Прайм" },
  { level: 2,  type: "case",   caseId: "summer26box", label: "Літо26 Бокс" },
  { level: 3,  type: "lbk",   amount: 400,          label: "400 ЛБК" },
  { level: 4,  type: "case",   caseId: "summer26",  label: "Літо26" },
  { level: 5,  type: "coins",  amount: 300,          label: "300 💰" },
  { level: 6,  type: "case",   caseId: "summerheat", label: "ЛітняСпека" },
  { level: 7,  type: "lbk",   amount: 600,          label: "600 ЛБК" },
  { level: 8,  type: "coins",  amount: 400,          label: "400 💰" },
  { level: 9,  type: "case",   caseId: "summerheat", label: "ЛітняСпека" },
  { level: 10, type: "lbk",   amount: 800,          label: "800 ЛБК Прайм" },

  { level: 11, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },
  { level: 12, type: "coins",  amount: 500,          label: "500 💰" },
  { level: 13, type: "lbk",   amount: 1000,         label: "1000 ЛБК" },
  { level: 14, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 15, type: "coins",  amount: 600,          label: "600 💰" },
  { level: 16, type: "lbk",   amount: 1000,         label: "1000 ЛБК" },
  { level: 17, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },
  { level: 18, type: "coins",  amount: 700,          label: "700 💰" },
  { level: 19, type: "lbk",   amount: 1200,         label: "1200 ЛБК" },
  { level: 20, type: "case",   caseId: "summergift26", label: "Літній Дар" },

  { level: 21, type: "coins",  amount: 800,          label: "800 💰" },
  { level: 22, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },
  { level: 23, type: "lbk",   amount: 1500,         label: "1500 ЛБК" },
  { level: 24, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 25, type: "coins",  amount: 1000,         label: "1000 💰" },
  { level: 26, type: "lbk",   amount: 1500,         label: "1500 ЛБК" },
  { level: 27, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 28, type: "coins",  amount: 1000,         label: "1000 💰" },
  { level: 29, type: "lbk",   amount: 2000,         label: "2000 ЛБК" },
  { level: 30, type: "case",   caseId: "mellstroy", label: "МеллстройКолекція" },

  { level: 31, type: "coins",  amount: 1200,         label: "1200 💰" },
  { level: 32, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 33, type: "lbk",   amount: 2000,         label: "2000 ЛБК" },
  { level: 34, type: "coins",  amount: 1200,         label: "1200 💰" },
  { level: 35, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 36, type: "lbk",   amount: 2500,         label: "2500 ЛБК" },
  { level: 37, type: "coins",  amount: 1500,         label: "1500 💰" },
  { level: 38, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 39, type: "lbk",   amount: 2500,         label: "2500 ЛБК" },
  { level: 40, type: "coins",  amount: 1500,         label: "1500 💰" },

  { level: 41, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 42, type: "lbk",   amount: 3000,         label: "3000 ЛБК" },
  { level: 43, type: "coins",  amount: 2000,         label: "2000 💰" },
  { level: 44, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 45, type: "lbk",   amount: 3000,         label: "3000 ЛБК" },
  { level: 46, type: "coins",  amount: 2000,         label: "2000 💰" },
  { level: 47, type: "case",   caseId: "summergift26", label: "Літній Дар" },
  { level: 48, type: "lbk",   amount: 4000,         label: "4000 ЛБК" },
  { level: 49, type: "coins",  amount: 2500,         label: "2500 💰" },
...
export const BP_WHEEL_TABLE = [
  { type: "coins",  amount: 50,  weight: 30, label: "50 💰" },
  { type: "coins",  amount: 100, weight: 20, label: "100 💰" },
  { type: "coins",  amount: 200, weight: 10, label: "200 💰" },
  { type: "case",   caseId: "summer26box",   weight: 25, label: "Літо26 Бокс (15💰)" },
  { type: "case",   caseId: "summer26",      weight: 15, label: "Літо26 (40💰)" },
  { type: "case",   caseId: "summerheat",    weight: 8,  label: "ЛітняСпека (100💰)" },
  { type: "case",   caseId: "mellstroy",     weight: 8,  label: "МеллстройКолекція (100💰)" },
  { type: "case",   caseId: "summergift26",  weight: 3,  label: "Літній Дар (150💰)" },
  { type: "lbk",   amount: 300, weight: 15, label: "300 ЛБК" },
  { type: "lbk",   amount: 500, weight: 8,  label: "500 ЛБК" },
];
