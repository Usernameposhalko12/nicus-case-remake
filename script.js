...
function updateBalanceDisplay() {
  ...
  if (navLogo) {
    navLogo.innerHTML = gameState.avatarUrl
      ? '<img src="' + gameState.avatarUrl + '" style="width:28px;height:28px;border-radius:50%;object-fit:cover;vertical-align:middle;margin-right:6px;border:1.5px solid var(--accent);"> <span style="vertical-align:middle;font-weight:800;letter-spacing:.5px;">НКР</span>'
      : 'НКР';
  }
}
