...
function drawSpecialMedalCanvas(size = 120) {
  ...
  glow.addColorStop(0, "rgba(255,80,200,0.55)");
  glow.addColorStop(0.5, "rgba(120,60,255,0.3)");
  ...
  for (let i = 0; i < 8; i++) {
    ...
    rg.addColorStop(0, "rgba(255,100,220,0)");
    rg.addColorStop(0.5, "rgba(255,100,220,0.18)");
    rg.addColorStop(1, "rgba(255,100,220,0)");
    ctx.fillStyle = rg;
    ctx.beginPath();
  ...
  // Основний кристал (шестикутник повернутий)
  const pts = 6;
  ...
  kg.addColorStop(0,   "#ff80f0");
  kg.addColorStop(0.3, "#cc44ff");
  kg.addColorStop(0.6, "#6644ff");
  kg.addColorStop(1,   "#44aaff");
    ...
    resultEl.innerHTML = `
      ...
      ">
        ...
        <div style="color:#888;font-size:13px;margin-bottom:8px;">🎉 Ви отримали!</div>
          ...
          style="width:80px;height:80px;object-fit:contain;display:block;margin:0 auto;filter:${isSpecialWin ? "drop-shadow(0 4px 16px rgba(180,0,255,0.6))" : "drop-shadow(0 3px 8px rgba(0,0,0,0.2))"};">
