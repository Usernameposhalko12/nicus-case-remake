...
const CASES = {
  summer26: {
    ...
    items: [
      { id: "item_a_spider",   name: "СпідерМан",          img: "img/items/l1.png",  rarity: "common"      },
      { id: "item_a_halal",    name: "Халяль",              img: "img/items/l2.png",  rarity: "common"      },
      { id: "item_a_pohuy",    name: "МеніПофіг",           img: "img/items/l3.png",  rarity: "exceptional" },
      { id: "item_a_zalojnik", name: "ДітиПідвалу",         img: "img/items/l4.png",  rarity: "exceptional" },
      { id: "item_a_rabbit",   name: "Привіт, Софійко!",    img: "img/items/l5.png",  rarity: "epic"        },
      { id: "item_a_what",     name: "ЩоЦеТаке?!",         img: "img/items/l6.png",  rarity: "epic"        },
      { id: "item_a_1gaben",   name: "Габен",               img: "img/items/l7.png",  rarity: "legendary"   },
      { id: "item_a_waterCat", name: "МокрийКіт",           img: "img/items/l8.png",  rarity: "legendary"   },
      { id: "item_a_dex",      name: "ЩосьНеТак…",         img: "img/items/l9.png",  rarity: "secret"      },
      { id: "item_a_diddy",    name: "Підіді",              img: "img/items/l10.png", rarity: "secret"      },
      { id: "item_a_jeky",     name: "Джекі",               img: "img/items/l11.png", rarity: "special"     },
      { id: "item_a_ducplin",  name: "Дисцепліньор",        img: "img/items/l12.png", rarity: "special"     },
    ]
  },
  ...
  try {
    ...
    if (!snap.exists()) {
      ...
      if (Object.keys(missing).length > 0) {
        await updateDoc(doc(db, "globalData", "cases"), missing);
        Object.keys(missing).forEach(k => { CASES[k].remaining = missing[k]; });
      }
    }
  } catch (e) {
