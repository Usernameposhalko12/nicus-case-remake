...
import {
  ...
  getMarketItemPrices, adminSetItemPriceRange, adminClearItemPriceRange,
} from "./firebase.js";

import { renderNotificationCenter } from "./notifications.js";

import { renderBlackMarket, openLockItemModal, bmInit } from "./blackmarket.js";
bmInit({ showToast, openModal, closeModal, saveData, renderInventory, updateBalanceDisplay });

import {
  MELLCRAFT_MELL_ITEMS, MELL_CRAFT_COINS, MELL_CRAFT_HP,
  MELL_HP_REWARDS, MELL_SPIN_COST, MELL_SPIN_TABLE,
  getMellCraftGlobal, subscribeGlobalMellHP,
  submitMellCraft, doMellSpin,
  adminResetMellHP, adminResetMellCoins,
} from "./mellcraft.js";

import {
  initBattlePass, destroyBattlePass,
  bpHookOpenCase, bpHookCraft, bpHookSpend, bpHookEarn,
  bpHookMarketSell, bpHookTrade, bpHookGift, bpHookLogin,
  bpHookMellCoins,  // ← ДОДАТИ
} from "./battlepass-ui.js";

import {
  renderPromoPage,
  renderAdminPromoPanel,
} from "./promo.js";

import { renderEcosystemHub } from "./hub.js";
...
const COLLECTIONS = {
 ...
 autumn26: {
    name: "Осінь26",
    cases: ["autumn26", "autumn26box", "radogosh26"],
  },
 osinnelystya: {
    name: "ОсіннєЛистя",
    cases: ["osinnelystya", "osinnelystya_elite"],
  },
};
...
const CASES = {
  summer26: {
    ...
    img: "img/cases/summer26.png", price: 40, total: 1000, remaining: 1000,
  ...
  summer26box: {
    ...
    img: "img/cases/summer26box.png", price: 15, total: 1500, remaining: 1500,
  ...
  summergift26: {
    ...
    img: "img/cases/summergift26.png", price: 300, total: 250, remaining: 250,
 ...
 summerheat: {
    ...
    img: "img/cases/summerheat.png", price: 100, total: 50, remaining: 50,
    // 40н — стандартний кейс, повний набір рідкостей
    chances: {
      common:      0.45,
      exceptional: 0.27,
...
mellstroy: {
    ...
    img: "img/cases/mellstroy.png", price: 100, total: 50, remaining: 50,
    // 40н — стандартний кейс, повний набір рідкостей
    chances: {
      common:      0.45,
      exceptional: 0.27,
  ...
  autumn26: {
    ...
    img: "img/cases/autumn26.png", price: 40, total: 1000, remaining: 1000,
    // 40н — стандартний кейс, повний набір рідкостей
    chances: {
      common:      0.45,
      exceptional: 0.27,
    ...
    items: [
      { id: "item_a_ryba",       name: "Риба",           img: "img/items/o1.png",  rarity: "common", collection: "autumn26" },
      { id: "item_a_inokit",     name: "ІноКіт",         img: "img/items/o2.png",  rarity: "common", collection: "autumn26" },
      { id: "item_a_strashno",   name: "Страшно",        img: "img/items/o3.png",  rarity: "exceptional", collection: "autumn26" },
      { id: "item_a_sonkit",     name: "Сон-Кіт",        img: "img/items/o4.png",  rarity: "exceptional", collection: "autumn26" },
      { id: "item_a_veselymuzh", name: "ВеселийМужик",   img: "img/items/o5.png",  rarity: "epic", collection: "autumn26" },
      { id: "item_a_tonistark",  name: "ТоніСтарк",      img: "img/items/o6.png",  rarity: "epic", collection: "autumn26" },
      { id: "item_a_harold2",    name: "Гарольд",        img: "img/items/o7.png",  rarity: "legendary", collection: "autumn26" },
      { id: "item_a_pocherk",    name: "Почерк",         img: "img/items/o8.png",  rarity: "legendary", collection: "autumn26" },
      { id: "item_a_minecraft",  name: "Майнкрафт",      img: "img/items/o9.png",  rarity: "secret", collection: "autumn26" },
      { id: "item_a_muzon",      name: "Музон",          img: "img/items/o10.png", rarity: "secret", collection: "autumn26" },
      { id: "item_a_pidtrymuye", name: "Підтримує!",     img: "img/items/o11.png", rarity: "special", collection: "autumn26" },
      { id: "item_a_jackiechan", name: "ДжекіЧан",       img: "img/items/o12.png", rarity: "special", collection: "autumn26" },
    ]
  },

  autumn26box: {
    id: "autumn26box", name: "Бокс Осінь26",
    img: "img/cases/autumn26box.png", price: 15, total: 1500, remaining: 1500,
    // 15н — бюджетний, тільки common→legendary, без secret/special
    chances: {
      common:      0.55,
      exceptional: 0.28,
      epic:        0.12,
  ...
  radogosh26: {
    id: "radogosh26", name: "Радогощ26",
    img: "img/cases/radogosh26.png", price: 600, total: 150, remaining: 150,
    // 600н — подарунковий, тільки epic+
    chances: {
      common:      0,
      exceptional: 0,
      epic:        0.45,
  ...
  osinnelystya: {
    id: "osinnelystya", name: "ОсіннєЛистя",
    img: "img/cases/osinnelystya.png", price: 100, total: 200, remaining: 200,
    // 100н — стандартний кейс, повний набір рідкостей
    chances: {
      common:      0.45,
      exceptional: 0.27,
      epic:        0.15,
    ...
    items: [
      { id: "item_a_kytyky",     name: "Китики",                   img: "img/items/f1.png",  rarity: "common", collection: "osinnelystya" },
      { id: "item_a_totya",      name: "Тотя",                      img: "img/items/f2.png",  rarity: "common", collection: "osinnelystya" },
      { id: "item_a_plisnyava",  name: "Пліснява",                  img: "img/items/f3.png",  rarity: "exceptional", collection: "osinnelystya" },
      { id: "item_a_poganets",   name: "Поганець",                  img: "img/items/f4.png",  rarity: "exceptional", collection: "osinnelystya" },
      { id: "item_a_tamnetak",   name: "ТамНеТакСпівається",        img: "img/items/f5.png",  rarity: "epic", collection: "osinnelystya" },
      { id: "item_a_kochbratan", name: "КочБратан",                 img: "img/items/f6.png",  rarity: "epic", collection: "osinnelystya" },
      { id: "item_a_folkvalley", name: "ФолкВаллей",                img: "img/items/f7.png",  rarity: "legendary", collection: "osinnelystya" },
      { id: "item_a_orel",       name: "Орел",                      img: "img/items/f8.png",  rarity: "legendary", collection: "osinnelystya" },
      { id: "item_a_chekushka",  name: "Чекушка",                   img: "img/items/f9.png",  rarity: "secret", collection: "osinnelystya" },
      { id: "item_a_sendvich",   name: "Сендвіч",                   img: "img/items/f10.png", rarity: "secret", collection: "osinnelystya" },
      { id: "item_a_richard",    name: "Річард",                    img: "img/items/f11.png", rarity: "special", collection: "osinnelystya" },
      { id: "item_a_patriot",    name: "Патріот",                   img: "img/items/f12.png", rarity: "special", collection: "osinnelystya" },
    ]
  },

  osinnelystya_elite: {
    id: "osinnelystya_elite", name: "ОсіннєЛистя ELITE",
    img: "img/cases/osinnelystya_elite.png", price: 300, total: 50, remaining: 50,
    // 300н — подарунковий, тільки epic+
    chances: {
      common:      0,
      exceptional: 0,
      epic:        0.45,
...
window._CASES_LIST = Object.values(CASES).map(c => ({
  id: c.id,
  name: c.name,
  img: c.img,
}));
...
Object.values(CASES).forEach(c => {
  c.items.forEach(item => {
    if (!_seenItems.has(item.id)) {
      _seenItems.add(item.id);
      window._ITEMS_LIST.push({
        id: item.id,
        name: item.name,
        img: item.img,
        rarity: item.rarity,
...
window._getUnreadNotificationsCountGlobal = getUnreadNotificationsCount;
...
let _isSaving      = false;
// Блок предметів тепер платний і зберігається на сервері (item.blockedUntil).
// Лишаємо ім'я/інтерфейс _lockedItems.has(id), щоб не чіпати всі місця коду,
// які вже на нього спираються (продаж/трейд/подарунок/крафт/общак).
const _lockedItems = {
  has(itemId) {
    const it = (gameState.inventory || []).find(i => i.id === itemId);
    return !!(it && it.blockedUntil && it.blockedUntil > Date.now());
  }
};
...
// В navigate() — знайди існуючий блок з _mellGlobalUnsub і додай скидання offscreen:
async function navigate(page) {
  ...
  if (page !== 'cups' && window._destroyCupsPage) {
    window._destroyCupsPage();
    window._destroyCupsPage = null;
  }

  if (page !== 'blindmine' && window._destroyBlindMinePage) {
    window._destroyBlindMinePage();
    window._destroyBlindMinePage = null;
  }

  if (page !== 'mellcraft' && _mellGlobalUnsub) {
    _mellGlobalUnsub();
    _mellGlobalUnsub = null;
  }

  // Скидаємо offscreen при виході з mellcraft
  if (page !== 'mellcraft') {
    _mellOffscreenCanvas = null;
    _mellOffscreenSegments = null;
  }
  ...
  // Слешпанель (navbar/bottom-nav) належить лише додатку НікусКейсРемейк —
  // на хабі та на сторінках авторизації її не показуємо.
  setNavVisible(!!currentUser && page !== 'hub');
  ...
  const tryRender = async (attempt) => {
    try {
      if (page === 'hub')            renderEcosystemHub(currentUser, () => navigate('main'));
      else if (page === 'notifications') { await renderNotificationCenter(currentUser); updateNotificationBadges(); }
      else if (page === 'blackmarket')   await renderBlackMarket(currentUser, gameState);
      ...
      else if (page === 'mellcraft') await renderMellCraft();
      else if (page === 'admin')     await renderAdmin();
      else if (page === 'promo') await renderPromoPage(gameState, currentUser, {
        showToast, openModal,
        updateBalanceDisplay, renderInventory,
      });
     else if (page === 'battlepass') {
await initBattlePass(currentUser, gameState, { showToast, openModal, closeModal, saveData, renderInventory, updateBalanceDisplay });
}
        ...
        await initCupsPage(currentUser, gameState, {
          showToast, openModal, closeModal, updateBalanceDisplay,
        });
      }
      else if (page === 'blindmine') {
        const { initBlindMinePage, destroyBlindMinePage } = await import('./blindmine.js');
        window._destroyBlindMinePage = destroyBlindMinePage;
        await initBlindMinePage(currentUser, gameState, {
          showToast, updateBalanceDisplay,
        });
      }
    } catch (e) {
      ...
      if (attempt < 3) {
        ...
        const containers = {
          ...
          mine: 'mine-page-root', notifications: 'page-notifications',
          cups: 'cups-page-root',
          blindmine: 'blindmine-page-root',
        };
...
async function login() {
  ...
  try {
    ...
    setNavVisible(true); navigate("hub");
...
if (_mellGlobalUnsub) { _mellGlobalUnsub(); _mellGlobalUnsub = null; }
...
function updateBalanceDisplay() {
  ...
  if (navLogo && window.innerWidth > 900) {
    if (!avatarEl) {
...
// ── ЦЕНТР ПОВІДОМЛЕНЬ: бейджі непрочитаних ──
function updateNotificationBadges() {
  if (!currentUser?.uid) return;
  getUnreadNotificationsCount(currentUser.uid).then(count => {
    [
      document.getElementById("notif-badge"),
      document.getElementById("notif-badge-mobile"),
      document.getElementById("notif-badge-main"),
    ].forEach(el => {
      if (!el) return;
...
async function buyCase(caseId, count) {
  ...
  await bpHookSpend(c.price * count);
...
// ─── 4. Оновлена openCase ───────────────────────────────────────
  ...
  if (_lockedItems.has(item.id)) { showToast("Кейс заблоковано! Спочатку зачекай, поки блок спливе.", "error"); return; }
...
async function openFastMode(invId) {
  const invIndex = gameState.inventory.findIndex(x => x.id === invId);
  if (invIndex === -1) return null;
  const item = gameState.inventory[invIndex];
  if (!item || item.type !== "case") return null;
  if (_lockedItems.has(item.id)) return null;
  const c = CASES[item.caseId];
  if (!c) return null;
  const dropped = rollDrop(c);
...
function showFastOpenModal() {
  ...
  const cases = (gameState.inventory || []).filter(i => i.type === "case" && !_lockedItems.has(i.id));
  if (!cases.length) { showToast("Немає доступних (незаблокованих) кейсів для відкриття!", "error"); return; }
...
async function doFastOpen() {
  ...
  for (const sel of selected) {
    const available = (gameState.inventory || []).filter(i => i.type === "case" && i.caseId === sel.caseId && !_lockedItems.has(i.id));
    const toOpen = Math.min(sel.qty, available.length);
    for (let i = 0; i < toOpen; i++) {
      const caseInv = gameState.inventory.find(x => x.type === "case" && x.caseId === sel.caseId && !_lockedItems.has(x.id));
      if (!caseInv) break;
     const result = await openFastMode(caseInv.id);
...
// ── БЛОКУВАННЯ ПРЕДМЕТІВ (платне, через чорний ринок) ──────
function toggleLock(itemId) {
  openLockItemModal(currentUser, gameState, itemId, () => renderInventory());
}
...
function inv2OpenPopup(e, itemId, realIdx) {
  ...
  pop.innerHTML = `
    ...
    <button class="inv2-popup-btn" onclick="closeItemPopup();toggleLock('${itemId}')">
      ${locked ? "🔒 Заблоковано (деталі)" : "🔒 Заблокувати"}
    </button>
  ...
  inv2OpenModal(`
    ...
    <div class="inv2-modal-btns">
      <button class="inv2-btn" onclick="inv2CloseModal();toggleLock('${item.id}')">
        ${_lockedItems.has(item.id)?"🔒 Заблоковано":"🔒 Заблок."}
      </button>
...
async function acceptBuyRequest(reqId, listingDocId, buyerId, offeredPrice) {
  try {
    ...
    const { collection: col2, query: q2, where: w2, getDocs: gds2 } = await import("https://www.gstatic.com/firebasejs/10.7.0/firebase-firestore.js");
    ...
    // Продавець реально отримав гроші — підтверджено Firestore
    await bpHookEarn(offeredPrice);
...
async function confirmSell(itemId) {
  ...
  try {
    ...
    await bpHookMarketSell(1);
    // bpHookEarn — НЕ тут, тільки коли реально куплять
    renderInventory();
  } catch (e) {
...
async function buyFromMarketItem(docId) {
  ...
  try {
    ...
    await bpHookSpend(l.price); // покупець витратив
    // продавець отримав — але ми не продавець, тому earn не тут
  } catch (e) {
    showToast("Помилка: " + e.message, "error");
...
async function showTradeModal(itemId) {
  ...
  let others = [];
  try { others = (await getAllUsernames()).filter(u => u !== currentUser?.username && !BOT_USERNAMES.includes(u)); } catch (e) {}
...
async function sendTradeNew() {
  ...
  if (BOT_USERNAMES.includes(target)) { showToast("Це бот, взаємодія з ботами обмежена!", "error"); return; }
...
async function sendGift() {
  ...
  try {
    ...
    await bpHookGift(1);
    // НЕ додаємо bpHookSpend — гіфт не є витратою для завдань
  } catch (e) { showToast(e.message || "Помилка!", "error"); }
}
...
async function doAcceptTrade(docId) {
  try {
    ...
    await bpHookTrade(1);
    // НЕ додаємо bpHookEarn — трейд це обмін, не заробіток
...
async function renderProfile(targetUsername) {
  ...
  page.innerHTML =
    '<div class="page-header">' +
      ...
      '<h1 class="page-title">' + (isOwnProfile ? "👤 Профіль" : (profileData.isBot ? "🤖 " : "👤 ") + (profileData.username || "Гравець")) + '</h1>' +
    '</div>' +
...
'<div class="profile-username">' + (profileData.username || "—") + '</div>' +
      '<div class="profile-badges">' +
        (profileData.isBot ? '<span class="badge" style="background:var(--accent);color:#fff;">🤖 Ринковий бот</span>' : '') +
...
async function addFriend() {
  ...
  if (BOT_USERNAMES.includes(username))           { showToast("Це бот, взаємодія з ботами обмежена!", "error"); return; }
...
gameState.inventory.push({
  ...
  name: reward.name, img: reward.img,
  fromCaseName: reward.name,
  source: "level_reward",
  obtainedBy: currentUser?.username || "?",
  obtainedAt: Date.now(),
  boughtAt: Date.now()
...
'<button class="btn-sm btn-buy"    onclick="adminGiveMellCoins(\'' + u.uid + '\',false)" style="background:rgba(255,230,100,0.15);border-color:#ffe066;color:#ffe066;">🪙+</button>' +
'<button class="btn-sm btn-cancel" onclick="adminGiveMellCoins(\'' + u.uid + '\',true)"  style="background:rgba(255,100,0,0.1);border-color:#ff6030;color:#ff8050;">🪙-</button>' +
...
'<button class="btn-secondary" style="font-size:12px;padding:6px 14px;" onclick="adminResetCases()">🔄 Ресет кейсів</button>' +
'<button class="btn-secondary" style="font-size:12px;padding:6px 14px;background:rgba(255,230,100,0.12);border-color:#ffe066;color:#ffe066;" onclick="adminMellCraftPanel()">🎭 МеллКрафт</button>' +

'<button class="btn-secondary" style="font-size:12px;padding:6px 14px;background:rgba(94,203,62,0.12);border-color:var(--teal);color:var(--teal);" onclick="adminBotsPanel()">🤖 Ринкові боти</button>' +
'<button class="btn-secondary" style="font-size:12px;padding:6px 14px;background:rgba(51,153,255,0.12);border-color:#3399FF;color:#3399FF;" onclick="adminBotPricesPanel()">💰 Ціни ботів</button>' +

'<button class="btn-secondary" style="font-size:12px;padding:6px 14px;" onclick="adminOpenBpPanel()">🏆 BattlePass</button>'+

'<button class="btn-secondary" style="font-size:12px;padding:6px 14px;background:rgba(255,215,0,0.12);border-color:#FFD700;color:#cc8800;" onclick="adminPromoPanel()">🎟️ Промокоди</button>'+
'</div>' +
...
async function adminMellCraftPanel() {
  const globalData = await getMellCraftGlobal();
  const totalHp    = globalData.totalHp || 0;
  const claimed    = (globalData.claimedLevels || []).join(", ") || "—";

  const userRows = _adminUsers.map(u => {
    const coins  = u.mellCoins   || 0;
    const contrib = u.mellHpContrib || 0;
    return `<div style="display:flex;align-items:center;justify-content:space-between;padding:8px 12px;background:var(--bg-card2);border-radius:8px;margin-bottom:6px;">
      <div>
        <span style="font-weight:700;">${u.username||u.uid}</span>
        <span style="color:#ffe066;margin-left:8px;">🪙 ${coins}</span>
        <span style="color:#5ddb8a;margin-left:8px;">⚡ ${contrib} ХП</span>
      </div>
      <button class="btn-sm btn-cancel" onclick="adminConfirmResetMellUser('${u.uid}','${u.username||u.uid}')">🔄 Скинути</button>
    </div>`;
  }).join("");

  openModal(`
    <h2 class="modal-title">🎭 МеллКрафт Адмін</h2>
    <div style="background:rgba(255,230,100,0.08);border:1.5px solid #ffe066;border-radius:10px;padding:12px;margin-bottom:14px;">
      <div style="font-weight:700;color:#ffe066;margin-bottom:4px;">🌍 Глобальний МеллХП: <b>${totalHp}</b> / 1000</div>
      <div style="font-size:12px;color:var(--text-muted);">Завершені рівні: ${claimed}</div>
    </div>
    <button class="btn-primary btn-full" onclick="adminConfirmResetGlobalMell()" style="margin-bottom:14px;background:linear-gradient(135deg,#e74c3c,#c0392b);">
      🔄 Скинути глобальний МеллХП (для всіх)
    </button>
    <div style="font-weight:700;color:var(--text);margin-bottom:8px;">Гравці:</div>
    <div style="max-height:300px;overflow-y:auto;">${userRows}</div>
    <button class="btn-secondary btn-full" style="margin-top:12px;" onclick="closeModal()">Закрити</button>
  `, true);
}

async function adminConfirmResetGlobalMell() {
  try {
    await adminResetMellHP();
    showToast("✅ Глобальний МеллХП скинуто!", "success");
    closeModal();
    await adminMellCraftPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}

async function adminConfirmResetMellUser(uid, username) {
  try {
    await adminResetMellCoins(uid);
    if (uid === currentUser?.uid) { gameState.mellCoins = 0; gameState.mellHpContrib = 0; }
    showToast("✅ МеллКоінс гравця " + username + " скинуто!", "success");
    closeModal();
    await adminMellCraftPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
...
async function adminPromoPanel() {
  await renderAdminPromoPanel({ showToast, openModal });
}
window.adminPromoPanel = adminPromoPanel;
...
async function adminOpenBpPanel() {
  if (window.renderAdminBpPanel) {
    await window.renderAdminBpPanel({ showToast, openModal, closeModal });
  } else {
    showToast("BattlePass модуль не завантажено!", "error");
  }
}
window.adminOpenBpPanel = adminOpenBpPanel;

// ── АДМІН: панель керування ринковими ботами ─

function _botTimeAgoOrIn(ms) {
  const abs = Math.abs(ms);
  const min = Math.round(abs / 60000);
  if (min < 1) return "менше хв";
  if (min < 60) return min + " хв";
  const h = Math.floor(min / 60), m = min % 60;
  return h + " год" + (m ? " " + m + " хв" : "");
}

async function adminBotsPanel() {
  let state = {};
  try { state = await getMarketBotsState(); } catch (e) { state = {}; }

  const botsEnabled  = state.botsEnabled !== false; // за замовчуванням увімкнено
  const disabledBots = state.disabledBots || [];
  const purchases    = state.recentPurchases || [];
  const now = Date.now();
  const nextBuyMs = Math.max(0, (state.lastTick || 0) + BOT_BUY_INTERVAL_MS - now);
  const specialCooldownMs = BOT_SPECIAL_COOLDOWN_TICKS * BOT_BUY_INTERVAL_MS;

  const botUsers = BOT_USERNAMES.map(name => {
    const u = _adminUsers.find(x => x.username === name) || {};
    return {
      name, uid: u.uid || ("bot_" + name),
      balance: u.balance || 0, inv: (u.inventory || []).length,
      budgetMonthKey: u.budgetMonthKey || "—",
      lastSpecialBuyAt: u.lastSpecialBuyAt || 0,
      lastSeen: u.lastSeen || 0,
    };
  });

  const rarityLimitsText = BOT_RARITY_PRIORITY.map(r => {
    const label = RARITIES[r]?.name || r;
    const cap = BOT_RARITY_CYCLE_CAPS[r];
    return label + ': ' + (cap != null ? '≤' + cap + '/чистку' : 'без ліміту рідкості');
  }).join(" · ");

  const botRows = botUsers.map(b => {
    const isOff = disabledBots.includes(b.name);
    const specialLeftMs = b.lastSpecialBuyAt ? Math.max(0, specialCooldownMs - (now - b.lastSpecialBuyAt)) : 0;
    return `<div style="padding:10px 12px;background:var(--bg-card2);border-radius:8px;margin-bottom:8px;">
      <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;">
        <div>
          <span style="font-weight:700;">${isOff ? '⏸️' : '🤖'} ${b.name}</span>
          <span style="color:var(--text-muted);margin-left:8px;font-size:13px;">💰 ${b.balance} / ${BOT_MONTHLY_BUDGET} | 🎒 ${b.inv} пр.</span>
          ${isOff ? '<span style="color:#e74c3c;margin-left:8px;font-size:12px;">вимкнено</span>' : ''}
        </div>
        <div style="display:flex;gap:6px;flex-wrap:wrap;">
          <button class="btn-sm btn-buy" onclick="adminGiveBalance('${b.uid}',false)">💰+</button>
          <button class="btn-sm btn-cancel" onclick="adminConfirmCollectBot('${b.uid}','${b.name}')">🏦 Забрати</button>
          <button class="btn-sm ${isOff ? 'btn-buy' : 'btn-cancel'}" onclick="adminToggleBotDisabled('${b.name}',${!isOff})">${isOff ? '▶️ Увімкнути' : '⏸️ Вимкнути'}</button>
        </div>
      </div>
      <div style="font-size:11px;color:var(--text-muted);margin-top:6px;">
        📅 Бюджетний місяць: ${b.budgetMonthKey} ·
        👁️ Був онлайн: ${b.lastSeen ? _botTimeAgoOrIn(now - b.lastSeen) + ' тому' : '—'} ·
        🌟 Спецпредмет: ${specialLeftMs > 0 ? 'перезарядка ще ' + _botTimeAgoOrIn(specialLeftMs) : 'доступний'}
      </div>
    </div>`;
  }).join("");

  const purchaseRows = purchases.length ? purchases.map(p => `
    <div style="display:flex;justify-content:space-between;gap:8px;padding:8px 10px;background:var(--bg-card2);border-radius:8px;margin-bottom:6px;font-size:12px;">
      <span>🤖 <b>${p.botName || '?'}</b> купив «${p.itemName || '?'}» у <b>${p.sellerName || '?'}</b></span>
      <span style="color:var(--text-muted);white-space:nowrap;">${p.price || 0} нік. · ${p.at ? _botTimeAgoOrIn(now - p.at) + ' тому' : ''}</span>
    </div>
  `).join("") : '<div style="color:var(--text-muted);font-size:13px;padding:8px 0;">Покупок ще не було.</div>';

  const errorBlock = state.lastError ? `
    <div style="background:rgba(231,76,60,0.1);border:1.5px solid #e74c3c;border-radius:10px;padding:10px 12px;margin-bottom:14px;font-size:12px;color:#e74c3c;">
      ⚠️ Остання помилка (${state.lastErrorAt ? _botTimeAgoOrIn(now - state.lastErrorAt) + ' тому' : '?'}): ${state.lastError}
    </div>` : '';

  openModal(`
    <h2 class="modal-title">🤖 Ринкові боти</h2>
    ${errorBlock}
    <div style="background:var(--bg-card2);border-radius:10px;padding:12px;margin-bottom:14px;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
        <span style="font-weight:700;">Статус: ${botsEnabled ? '<span style="color:#5ddb8a;">✅ Увімкнено</span>' : '<span style="color:#e74c3c;">🚫 Вимкнено</span>'}</span>
        <button class="btn-sm ${botsEnabled ? 'btn-cancel' : 'btn-buy'}" onclick="adminToggleAllBots(${!botsEnabled})">${botsEnabled ? '🚫 Вимкнути всіх' : '✅ Увімкнути всіх'}</button>
      </div>
      <div style="font-size:13px;color:var(--text-muted);margin-bottom:6px;">⏱️ До наступної чистки: <b>${nextBuyMs <= 0 ? 'зараз/при наступному тіку' : _botTimeAgoOrIn(nextBuyMs)}</b></div>
      <div style="font-size:11px;color:var(--text-muted);margin-bottom:10px;">
        Ліміт за 1 чистку (кожні 30 хв): <b>${BOT_MAX_ITEMS_PER_CYCLE}</b> предметів на бота.<br>${rarityLimitsText}
      </div>
      <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <button class="btn-secondary btn-sm" onclick="adminConfirmResetBotTimer()">🔄 Скинути таймер</button>
        <button class="btn-secondary btn-sm" onclick="adminConfirmMarketSweep()">🧹 Зачистка ринку зараз</button>
      </div>
    </div>
    <div style="font-weight:700;color:var(--text);margin-bottom:8px;">Боти:</div>
    <div style="margin-bottom:14px;">${botRows}</div>
    <div style="font-weight:700;color:var(--text);margin-bottom:8px;">Останні покупки (до 25):</div>
    <div style="max-height:220px;overflow-y:auto;margin-bottom:8px;">${purchaseRows}</div>
    <button class="btn-secondary btn-full" style="margin-top:8px;" onclick="closeModal()">Закрити</button>
  `, true);
}
window.adminBotsPanel = adminBotsPanel;

async function adminToggleAllBots(enable) {
  try {
    await adminSetBotsEnabled(enable);
    showToast(enable ? "✅ Боти увімкнені" : "🚫 Боти вимкнені", "success");
    await adminBotsPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminToggleAllBots = adminToggleAllBots;

async function adminToggleBotDisabled(name, disable) {
  try {
    await adminSetBotDisabled(name, disable);
    showToast((disable ? "⏸️ " + name + " вимкнено" : "▶️ " + name + " увімкнено"), "success");
    await adminBotsPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminToggleBotDisabled = adminToggleBotDisabled;

async function adminConfirmResetBotTimer() {
  try {
    await adminResetBotBuyTimer();
    showToast("🔄 Таймер скинуто — наступна покупка при найближчому тіку", "success");
    await adminBotsPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminConfirmResetBotTimer = adminConfirmResetBotTimer;

async function adminConfirmMarketSweep() {
  showToast("🧹 Проводимо зачистку ринку...", "success");
  try {
    await adminTriggerMarketSweep();
    showToast("✅ Зачистку ринку завершено", "success");
    try { const snap = await getDocs(collection(db, "users")); _adminUsers = snap.docs.map(d => ({ uid: d.id, ...d.data() })); } catch (e) {}
    await adminBotsPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminConfirmMarketSweep = adminConfirmMarketSweep;

async function adminConfirmCollectBot(botUid, botName) {
  if (!currentUser?.uid) return;
  try {
    await adminCollectBotBalance(botUid, currentUser.uid);
    showToast("🏦 Баланс бота " + botName + " забрано на твій рахунок", "success");
    try {
      const snap = await getDoc(doc(db, "users", currentUser.uid));
      if (snap.exists()) { gameState.balance = snap.data().balance || 0; updateBalanceDisplay(); }
    } catch (e) {}
    try { const snap2 = await getDocs(collection(db, "users")); _adminUsers = snap2.docs.map(d => ({ uid: d.id, ...d.data() })); } catch (e) {}
    await adminBotsPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminConfirmCollectBot = adminConfirmCollectBot;

// ── АДМІН: ДІАПАЗОНИ ЦІН ПО ПРЕДМЕТУ ДЛЯ БОТІВ ──────
function _adminBotPricesAllItems() {
  const allItems = [];
  const seen = new Set();
  Object.values(CASES).forEach(c => {
    c.items.forEach(item => {
  ...
  const ro = ["special","secret","legendary","epic","exceptional","common"];
  allItems.sort((a,b) => ro.indexOf(a.rarity) - ro.indexOf(b.rarity) || a.name.localeCompare(b.name, "uk"));
  return allItems;
}

async function adminBotPricesPanel() {
  let itemPrices = {};
  try { itemPrices = await getMarketItemPrices(); } catch (e) { itemPrices = {}; }
  const allItems = _adminBotPricesAllItems();

  const rows = allItems.map(item => {
    const r = RARITIES[item.rarity];
    const range = itemPrices[item.id] || {};
    const hasRange = range.min != null || range.max != null;
    return `<div class="admin-bp-row" data-search="${(item.name + ' ' + (r?r.name:item.rarity)).toLowerCase()}"
        style="padding:10px 12px;background:var(--bg-card2);border-radius:8px;margin-bottom:8px;">
      <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;margin-bottom:8px;">
        <div>
          <span style="font-weight:700;">${item.name}</span>
          <span style="margin-left:8px;font-size:11px;padding:2px 8px;border-radius:20px;background:${r?r.color+'22':'#8882'};color:${r?r.color:'#888'};">${r?r.name:item.rarity}</span>
        </div>
        <span style="font-size:11px;color:${hasRange?'#5ddb8a':'var(--text-muted)'};">${hasRange ? '✅ задано' : '— за медіаною'}</span>
      </div>
      <div style="display:flex;gap:6px;align-items:center;flex-wrap:wrap;">
        <input type="number" min="0" placeholder="мін." value="${range.min != null ? range.min : ''}"
          id="bp-min-${item.id}" style="width:80px;padding:6px 8px;border-radius:6px;border:1px solid var(--border);background:var(--bg-input);color:var(--text);font-size:12px;">
        <span style="color:var(--text-muted);">—</span>
        <input type="number" min="0" placeholder="макс." value="${range.max != null ? range.max : ''}"
          id="bp-max-${item.id}" style="width:80px;padding:6px 8px;border-radius:6px;border:1px solid var(--border);background:var(--bg-input);color:var(--text);font-size:12px;">
        <button class="btn-sm btn-buy" onclick="adminSaveItemPriceRange('${item.id}')">💾</button>
        ${hasRange ? `<button class="btn-sm btn-cancel" onclick="adminClearItemPriceRangeUI('${item.id}')">✖ Скинути</button>` : ''}
      </div>
    </div>`;
  }).join("");

  openModal(`
    <h2 class="modal-title">💰 Ціни ботів по предметах</h2>
    <p style="color:var(--text-muted);font-size:13px;margin-bottom:10px;">
      Якщо задати діапазон — бот купуватиме лот цього предмета ЛИШЕ якщо його ціна в межах [мін, макс], незалежно від медіани ринку. Це закриває експлойти з лотами-приманками. Без діапазону — стара логіка (медіана мінус 25%).
    </p>
    <input type="text" class="market-search" placeholder="🔍 Пошук предмета..." oninput="adminFilterBotPrices(this.value)" style="width:100%;box-sizing:border-box;margin-bottom:12px;">
    <div id="admin-bot-prices-list" style="max-height:420px;overflow-y:auto;">${rows}</div>
    <button class="btn-secondary btn-full" style="margin-top:12px;" onclick="closeModal()">Закрити</button>
  `, true);
}
window.adminBotPricesPanel = adminBotPricesPanel;

function adminFilterBotPrices(q) {
  document.querySelectorAll('.admin-bp-row').forEach(row => {
    row.style.display = row.getAttribute('data-search').includes(q.toLowerCase()) ? '' : 'none';
  });
}
window.adminFilterBotPrices = adminFilterBotPrices;

async function adminSaveItemPriceRange(itemId) {
  const minEl = document.getElementById('bp-min-' + itemId);
  const maxEl = document.getElementById('bp-max-' + itemId);
  const min = minEl && minEl.value !== '' ? minEl.value : null;
  const max = maxEl && maxEl.value !== '' ? maxEl.value : null;
  try {
    await adminSetItemPriceRange(itemId, min, max);
    showToast("💾 Діапазон збережено", "success");
    await adminBotPricesPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminSaveItemPriceRange = adminSaveItemPriceRange;

async function adminClearItemPriceRangeUI(itemId) {
  try {
    await adminClearItemPriceRange(itemId);
    showToast("✖ Діапазон скинуто — знову за медіаною", "success");
    await adminBotPricesPanel();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
window.adminClearItemPriceRangeUI = adminClearItemPriceRangeUI;
...
async function adminGiveMellCoins(uid, subtract) {
  const u = _adminUsers.find(x => x.uid === uid);
  openModal(
    '<h2 class="modal-title">' + (subtract ? '🪙 Відняти' : '🪙 Видати') + ' МеллКоінс</h2>' +
    '<p style="color:var(--text-muted);">Гравець: <b>' + (u?.username || uid) + '</b> | МеллКоінс: <b>' + (u?.mellCoins || 0) + '</b></p>' +
    '<input type="number" id="admin-mell-amt" class="form-input" value="50" min="1" style="width:100%;box-sizing:border-box;margin:12px 0;">' +
    '<div style="display:flex;gap:8px;">' +
      '<button class="btn-primary" style="flex:1;" onclick="adminConfirmMellCoins(\'' + uid + '\',' + subtract + ')">OK</button>' +
      '<button class="btn-secondary" style="flex:1;" onclick="closeModal()">Скасувати</button>' +
    '</div>'
  );
}

async function adminConfirmMellCoins(uid, subtract) {
  const amount = parseInt(document.getElementById('admin-mell-amt')?.value);
  if (isNaN(amount) || amount <= 0) { showToast("Введіть суму!", "error"); return; }
  try {
    const snap = await getDoc(doc(db, "users", uid));
    const cur  = snap.data()?.mellCoins || 0;
    const newVal = subtract ? Math.max(0, cur - amount) : cur + amount;
    await updateDoc(doc(db, "users", uid), { mellCoins: newVal });
    if (uid === currentUser?.uid) {
      gameState.mellCoins = newVal;
      const coinsEl = document.getElementById("mellcoins-display");
      if (coinsEl) coinsEl.textContent = newVal;
    }
    closeModal();
    showToast((subtract ? "🪙 Відраховано " : "✅ Видано ") + amount + " МеллКоінс!", "success");
    await renderAdmin();
  } catch (e) { showToast("Помилка: " + e.message, "error"); }
}
...
// Літні теми (день/ніч/вечір) — 🌊 / ☀️. Осіння тема — 🍁 / 🍂.
function updateSeasonEmojis(theme) {
  const isAutumn = theme === "autumn";
  const logoEmoji  = isAutumn ? "🍁" : "🌊";
  const titleEmoji = isAutumn ? "🍂" : "☀️";

  const authLogo   = document.getElementById("auth-logo-emoji");
  const heroAvatar = document.getElementById("hero-avatar-emoji");
  const mainTitle  = document.getElementById("main-title-emoji");

  if (authLogo)   authLogo.textContent   = logoEmoji;
  if (heroAvatar) heroAvatar.textContent = " " + logoEmoji + " ";
  if (mainTitle)  mainTitle.textContent  = titleEmoji;
}

function applyTheme(theme) {
  document.body.classList.remove("theme-dark", "theme-summer", "theme-autumn");
  if (theme === "dark")   document.body.classList.add("theme-dark");
  if (theme === "summer") document.body.classList.add("theme-summer");
  if (theme === "autumn") document.body.classList.add("theme-autumn");
  localStorage.setItem("nkr_theme", theme);
  const icons = { light: "☀️", dark: "🌙", summer: "🌅", autumn: "🍂" };
...
function initTheme() {
  ...
  const icons = { light: "☀️", dark: "🌙", summer: "🌅", autumn: "🍂" };
  const btn = document.getElementById("theme-toggle-btn");
  if (btn) btn.textContent = icons[saved] || "☀️";
}
...
function toggleTheme() {
  const themes = ["light", "dark", "summer", "autumn"];
...
let _bpLoginDone = false;
let _marketBotsInterval = null; // тік ринкових ботів (раз на хвилину, реальні дії — раз на 30 хв)
...
window.addEventListener('DOMContentLoaded', () => {
 ...
 onAuthStateChanged(auth, async (firebaseUser) => {
  if (firebaseUser) {
    ...
    // Ринкові боти: перевіряємо/запускаємо тік одразу і потім раз на хвилину.
    // Сама функція вирішує, чи настав час покупки (кожні 30 хв) чи неділі (зачистка ринку).
    runMarketBotsTick().catch(e => console.warn("Bot tick error:", e));
    if (_marketBotsInterval) clearInterval(_marketBotsInterval);
    _marketBotsInterval = setInterval(() => {
      runMarketBotsTick().catch(e => console.warn("Bot tick error:", e));
    }, 60 * 1000);
    ...
    _unsubProfile = onSnapshot(doc(db, "users", firebaseUser.uid), (snap) => {
      ...
      const _hubPageEl = document.getElementById('page-hub');
      const _onHubNow = _hubPageEl && _hubPageEl.style.display !== 'none';
      setNavVisible(!_onHubNow);
      updateBalanceDisplay();

      // Завантажуємо назву клану
      if (gameState.clan) {
        if (_clanNameCache[gameState.clan]) {
          // Одразу підставляємо назву з кешу, щоб не блимав айді клану
          gameState._clanName = _clanNameCache[gameState.clan];
        }
        getClan(gameState.clan).then(c => {
          if (c) {
            _clanNameCache[gameState.clan] = c.name;
            gameState._clanName = c.name;
            renderMain();
          } else {
            console.warn("Клан не знайдено в базі:", gameState.clan);
          }
        }).catch(err => {
          console.error("Не вдалося завантажити назву клану:", gameState.clan, err);
        });
      }
...
if (onAuthPage) {
  ...
  if (!_bpLoginDone) {
    ...
    if (_marketBotsInterval) { clearInterval(_marketBotsInterval); _marketBotsInterval = null; }
    stopMarketSubscription();
    currentUser = null; gameState = {}; _adminAuthed = false;
    setNavVisible(false); showAllPages(false);
    document.getElementById('page-login').style.display = 'block';
...
// ══════════════════════════════════════════════════════════════════
// МЕЛЛКРАФТ — ПОВНИЙ ПАТЧ (замінити відповідні функції в script.js)
// ══════════════════════════════════════════════════════════════════

// Offscreen canvas для статичного колеса
let _mellOffscreenCanvas = null;
let _mellOffscreenSegments = null;

function buildOffscreenWheel(segments) {
  ...
  ctx.scale(dpr, dpr);   // ← ключовий рядок
  const cx = size / 2, cy = size / 2;
  const R  = cx - 8;
  ...
  segments.forEach((seg) => {
    ...
    const imgDist = R * 0.62;
    const imgX = cx + Math.cos(midAngle) * imgDist;
    const imgY = cy + Math.sin(midAngle) * imgDist;
    const cachedImg = seg.visual?.img ? _mellImgCache[seg.visual.img] : null;
    ...
    if (cachedImg) {
      ...
      ctx.drawImage(cachedImg, -sz / 2, -sz / 2, sz, sz);
    } else {
      const fsz = Math.max(10, Math.min(R * 0.20, 22));
      ctx.font = `${fsz}px Arial`;
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.fillText(seg.visual?.emoji || "🎁", 0, 0);
    }
    ctx.restore();
  ...
  _mellOffscreenCanvas = off;
  _mellOffscreenSegments = segments;
}

function drawWheel(canvas, segments, rotation) {
  const dpr = window.devicePixelRatio || 1;
  const logW = canvas.width  / dpr;  // логічний розмір
  const logH = canvas.height / dpr;

  // Ресайзимо фізичний буфер якщо треба
  ...
  if (!_mellOffscreenCanvas || _mellOffscreenSegments !== segments) {
    buildOffscreenWheel(segments);
  }

  ctx.clearRect(0, 0, canvas.width, canvas.height);
  ctx.save();
  ctx.scale(dpr, dpr);           // ← масштабуємо контекст
  ctx.translate(cx, cy);
  ctx.rotate(rotation);
  ctx.drawImage(_mellOffscreenCanvas, -cx, -cy, logW, logH);  // ← явно вказуємо логічний розмір
  ctx.restore();
}

function drawArrow(arrowCanvas) {
  const ctx = arrowCanvas.getContext("2d");
  const w   = arrowCanvas.width;
  const h   = arrowCanvas.height;
...
async function _startMellWheelSpin(power) {
  const coins = gameState.mellCoins || 0;
  if (coins < MELL_SPIN_COST) {
    showToast("❌ Потрібно " + MELL_SPIN_COST + " МеллКоінс!", "error");
    return;
  }

  _mellSpring.spinning = true;
  const canvas = document.getElementById("mell-wheel-canvas");
  if (canvas) canvas.classList.add("spinning");
  _setSpinBtnDisabled(true);

  const segments = _mellSpring.segments;

  // ── КРОК 1: Спочатку отримуємо приз від сервера ──
  let prize = null;
  try {
    prize = await doMellSpin(currentUser.uid, gameState, currentUser.username || "");
  } catch (e) {
    showToast("❌ " + e.message, "error");
    _mellSpring.spinning = false;
    if (canvas) canvas.classList.remove("spinning");
    _setSpinBtnDisabled(false);
    return;
  }

  if (!prize) {
    showToast("❌ Помилка отримання призу", "error");
    _mellSpring.spinning = false;
    if (canvas) canvas.classList.remove("spinning");
    _setSpinBtnDisabled(false);
    return;
  ...
  // ── КРОК 2: Знаходимо індекс сегмента для цього призу ──
  const prizeIdx = MELL_SPIN_TABLE.findIndex(e =>
    (e.type === "item" && e.itemId === prize.itemId) ||
    (e.type === "case" && e.caseId === prize.caseId)
  );
  const targetIdx = prizeIdx >= 0 ? prizeIdx : 0;

  // Обчислюємо кут центру цільового сегмента
  let segStart = 0;
  for (let i = 0; i < targetIdx; i++) segStart += segments[i].angle;
  const segMid = segStart + segments[targetIdx].angle / 2;

  // Кут куди має стати стрілка (стрілка зверху = -PI/2)
  // Колесо повертається, тому щоб сегмент потрапив під стрілку:
  // rotation = -PI/2 - segMid + невеличкий random офсет в межах сегмента
  const halfSeg = segments[targetIdx].angle / 2;
  const randomOffset = (Math.random() - 0.5) * halfSeg * 0.6; // ±30% від центру сегмента
  const targetAngle = -Math.PI / 2 - segMid + randomOffset;

  // ── КРОК 3: Анімація з гарантованим попаданням ──
  const startRot = _mellSpring.rotation;
  const startTime = performance.now();

  // Скільки повних обертів додати (мінімум 5, більше = швидший спін)
  const extraRounds = (5 + Math.floor(power * 4)) * Math.PI * 2;

  // Нормалізуємо різницю: забезпечуємо що колесо крутиться вперед на extraRounds
  // плюс дотягується до потрібного кута
  ...
  await new Promise(resolve => {
    function animate(now) {
      const c = document.getElementById("mell-wheel-canvas");
      if (!c) { resolve(); return; }

      const elapsed = now - startTime;
      const t = Math.min(elapsed / totalDuration, 1);
      _mellSpring.rotation = startRot + easeOut(t) * totalRotation;
      drawWheel(c, segments, _mellSpring.rotation);

      if (t >= 1) {
        resolve();
      } else {
        _mellSpring.animId = requestAnimationFrame(animate);
      }
    }
    _mellSpring.animId = requestAnimationFrame(animate);
  });

  // ── КРОК 4: Синхронізуємо стан з Firestore ──
  try {
    const snap = await getDoc(doc(db, "users", currentUser.uid));
    if (snap.exists()) {
      gameState.mellCoins     = snap.data().mellCoins     || 0;
      gameState.mellHpContrib = snap.data().mellHpContrib || 0;
      gameState.inventory     = snap.data().inventory     || [];
    }
    const coinsEl = document.getElementById("mellcoins-display");
    if (coinsEl) coinsEl.textContent = gameState.mellCoins;
    renderInventory();
  } catch (e) {
    console.warn("Firestore sync error after spin:", e);
  }

  // ── КРОК 5: Показуємо результат ──
  _mellFinish(prize);
}

async function renderMellCraft() {
  injectMellCraftStyles();
  injectMellSpinStyles();

  const page = document.getElementById("page-mellcraft");
  if (!page) return;

  if (_mellGlobalUnsub) { _mellGlobalUnsub(); _mellGlobalUnsub = null; }

  const mellCoins   = gameState.mellCoins   || 0;
  const mellContrib = gameState.mellHpContrib || 0;

  let globalData = { totalHp: 0, claimedLevels: [] };
  try {
    globalData = await getMellCraftGlobal();
  } catch(e) {
    console.error("getMellCraftGlobal error:", e);
  }
  _mellGlobalData = globalData;
  const totalHp = globalData.totalHp    || 0;
  const claimed = globalData.claimedLevels || [];

  let segments = [];
  try {
    segments = buildMellWheelSegments();
  } catch(e) {
    console.error("buildMellWheelSegments error:", e);
  }
  ...
  if (!segments.length) {
    page.innerHTML = `
      <div style="padding:32px;text-align:center;color:var(--text-muted);">
        ...
        <div style="font-weight:700;margin-bottom:8px;">Помилка завантаження МеллКрафт</div>
        <div style="font-size:13px;margin-bottom:16px;">MELL_SPIN_TABLE не завантажена. Перевір mellcraft.js</div>
        <button class="btn-primary" onclick="navigate('mellcraft')">🔄 Спробувати знову</button>
      </div>`;
    return;
  }

  _mellSpring.segments = segments;

  try {
    await preloadWheelImages(segments);
  } catch(e) {
    console.warn("preloadWheelImages error:", e);
  }

  // Будуємо offscreen одразу після завантаження картинок
  _mellOffscreenCanvas = null;
  buildOffscreenWheel(segments);

  const maxHp = 1000;
  const hpPct = Math.min(100, (totalHp / maxHp) * 100);

  const milestonesHtml = (MELL_HP_REWARDS || [])
    .filter(m => m.hp > 0)
    .map(m => {
      const pct    = (m.hp / maxHp) * 100;
      const isDone  = claimed.includes(m.hp);
      const reached = totalHp >= m.hp;
      return `<div class="mellhp-milestone${isDone ? " done" : ""}"
        style="left:${pct}%"
        title="${m.reward.label} @ ${m.hp} HP${isDone ? " ✅" : ""}">
        ${isDone ? "✅" : reached ? "🔓" : "🎁"}
      </div>`;
    }).join("");

  page.innerHTML = `
    <div class="mellcraft-header">
      <div class="mellcraft-stat">
        <span class="mellcraft-stat-icon">🪙</span>
        <div>
          <div class="mellcraft-stat-val" id="mellcoins-display">${mellCoins}</div>
          <div class="mellcraft-stat-label">МеллКоінс</div>
        </div>
      </div>
      <div class="mellcraft-stat">
        <span class="mellcraft-stat-icon">⚡</span>
        <div>
          <div class="mellcraft-stat-val">${mellContrib}</div>
          <div class="mellcraft-stat-label">Мій внесок ХП</div>
        </div>
      </div>
    </div>

    <div class="mellhp-bar-wrap">
      <div style="display:flex;justify-content:space-between;font-size:12px;font-weight:700;color:var(--text-muted);margin-bottom:6px;">
        <span>🌍 Глобальний МеллХП</span>
        <span>${totalHp} / ${maxHp}</span>
      </div>
      <div class="mellhp-bar">
        <div class="mellhp-fill" style="width:${hpPct}%"></div>
        ${milestonesHtml}
      </div>
      <div style="font-size:11px;color:var(--text-dim);margin-top:6px;text-align:center;">
        Крафть предмети Меллстрой → накопичуйте МеллХП разом для нагород!
      </div>
    </div>

    <div class="mell-two-col">
      <div class="mell-section">
        <div class="mell-section-title">🎰 МеллКолесо</div>
        <div class="mell-wheel-wrap">
          <canvas id="mell-arrow-canvas" width="40" height="22"></canvas>
          <canvas id="mell-wheel-canvas" width="260" height="260" style="width:260px;height:260px;"></canvas>
        </div>
        <div class="mell-spring-bar-wrap">
          <div class="mell-spring-label">Сила кручення</div>
          <div class="mell-spring-track">
            <div class="mell-spring-fill" id="mell-spring-fill" style="width:0%"></div>
          </div>
          <div class="mell-spring-hint" id="mell-spring-hint">Затисни і тягни вниз для кручення</div>
        </div>
        <div class="mell-spin-result-inline" id="mell-spin-result-inline"></div>
        <button class="mell-spin-action-btn" id="mell-spin-inline-btn"
          onclick="_startMellWheelSpin(window._mellSpring.power || 0.5)"
          ${mellCoins < MELL_SPIN_COST ? "disabled" : ""}>
          🎰 Крутити (${MELL_SPIN_COST} 🪙)
          <div class="mell-spin-cost">Потрібно ${MELL_SPIN_COST} МеллКоінс</div>
        </button>
        <button class="btn-secondary" style="font-size:12px;padding:7px;" onclick="openMellSpinModal()">
          📊 Таблиця шансів
        </button>
      </div>

      <div class="mell-section">
        <div class="mell-section-title">⚗️ МеллКрафт</div>
        <div style="font-size:11px;color:var(--text-muted);text-align:center;margin-bottom:4px;">
          5 предметів Меллстрой однієї рідкості → вищу рідкість + МеллКоінс
        </div>
        <div id="mellcraft-slots" class="craft-slots"></div>
        <div id="mellcraft-info" style="margin-bottom:8px;"></div>
        <button id="mellcraft-btn" class="btn-primary btn-full" onclick="doMellCraftAction()" disabled>
          ⚗️ Крафтити
        </button>
        <div style="font-size:11px;font-weight:700;color:var(--text-muted);margin:8px 0 4px;text-transform:uppercase;letter-spacing:.8px;">
          Предмети Меллстрой:
        </div>
        <div id="mellcraft-picker" class="craft-picker"></div>
      </div>
    </div>
  `;

const wheelCanvas = document.getElementById("mell-wheel-canvas");
if (wheelCanvas) {
  const dpr = window.devicePixelRatio || 1;
  wheelCanvas.width  = 260 * dpr;
  wheelCanvas.height = 260 * dpr;
  wheelCanvas.style.width  = "260px";
  wheelCanvas.style.height = "260px";
  drawWheel(wheelCanvas, segments, _mellSpring.rotation);
  _attachSpringEvents(wheelCanvas);
}
  const arrowCanvas = document.getElementById("mell-arrow-canvas");
  if (wheelCanvas) {
    drawWheel(wheelCanvas, segments, _mellSpring.rotation);
    _attachSpringEvents(wheelCanvas);
  }
  if (arrowCanvas) drawArrow(arrowCanvas);
  ...
  try {
    _mellGlobalUnsub = await subscribeGlobalMellHP(data => {
      _mellGlobalData = data;
      const hp     = data.totalHp || 0;
      const hpPct2 = Math.min(100, (hp / maxHp) * 100);
      const fill   = document.querySelector(".mellhp-fill");
      if (fill) fill.style.width = hpPct2 + "%";
    });
  } catch(e) {
    console.warn("subscribeGlobalMellHP error:", e);
  }
}

// ── СТИЛІ ──────────────────────────────────────────────────────────
function injectMellCraftStyles() {
  if (document.getElementById("mellcraft-styles")) return;
  const s = document.createElement("style");
  s.id = "mellcraft-styles";
  s.textContent = `
    /* ── Загальна сторінка МеллКрафт ── */
    #page-mellcraft {
      padding-bottom: 30px;
    }
    ...
    .mellcraft-stat-icon { font-size: 24px; }
    .mellcraft-stat-val  { font-size: 20px; font-weight: 800; color: var(--text); }
    .mellcraft-stat-label { font-size: 11px; color: var(--text-muted); }

    /* ── Двоколонна секція (Колесо + Крафт) ── */
    .mell-two-col {
      display: grid;
    ...
    @media (max-width: 560px) {
      .mell-two-col { grid-template-columns: 1fr; }
    }
    ...
    .mell-spin-action-btn:hover:not(:disabled) {
      filter: brightness(1.08);
      transform: translateY(-1px);
    }
    .mell-spin-action-btn:disabled {
      background: var(--bg-input);
      color: var(--text-dim);
      cursor: not-allowed;
      box-shadow: none;
    ...
    /* ── Результат спіну (inline) ── */
    .mell-spin-result-inline {
      display: none;
      text-align: center;
      padding: 10px;
      border-radius: 10px;
    ...
    /* ── Крафт секція ── */
    .craft-slots { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 10px; }
    .craft-slot {
    ...
    .craft-slot img { width: 44px; height: 44px; object-fit: contain; }
    .craft-slot.empty { color: var(--text-muted); font-size: 22px; }
    ...
    .craft-pick-item img { width: 36px; height: 36px; object-fit: contain; flex-shrink: 0; }
    .craft-pick-item span { font-size: 12px; font-weight: 600; color: var(--text); }
    .craft-dim { opacity: 0.3; pointer-events: none; }
    ...
    .mellhp-fill {
      height: 100%;
      background: linear-gradient(90deg, #5ddb8a, #00c9a7);
      border-radius: 9px;
    ...
    .mellhp-milestone.done { opacity: 0.5; }
...
// ── ТАБЛИЦЯ СЕГМЕНТІВ ──────────────────────────────────────────────
// Картинки для кожного призу (img або emoji fallback)
const MELL_SEGMENT_VISUALS = {
  "item_a_artur": { img: "img/items/m11.png",        emoji: "👋" },
  "item_a_bem":   { img: "img/items/m12.png",        emoji: "💥" },
  "item_a_relax": { img: "img/items/m9.png",         emoji: "😌" },
  "item_a_fpv":   { img: "img/items/m10.png",        emoji: "🚁" },
  "item_a_hlop":  { img: "img/items/m7.png",         emoji: "👏" },
  "item_a_red":   { img: "img/items/m8.png",         emoji: "🔴" },
  "mellstroy":    { img: "img/cases/mellstroy.png",  emoji: "📦" },
};

function buildMellWheelSegments() {
  if (!MELL_SPIN_TABLE || !MELL_SPIN_TABLE.length) {
    console.error("MELL_SPIN_TABLE порожня або не завантажена!");
    return [];
  }
  const count = MELL_SPIN_TABLE.length;
  const equalAngle = (Math.PI * 2) / count;

  return MELL_SPIN_TABLE.map((entry, i) => {
    let color = "#2a2a3a";
    if (entry.type === "item") {
      const r = RARITIES[entry.rarity];
      color = r ? r.color : "#555";
    } else {
      color = "#c89820";
    }
    const bright = i % 2 === 0 ? color + "dd" : color + "99";
    const visual = entry.type === "case"
      ? MELL_SEGMENT_VISUALS["mellstroy"]
      : MELL_SEGMENT_VISUALS[entry.itemId] || { emoji: "🎁" };
    return { ...entry, angle: equalAngle, color: bright, visual };
  });
}

// ── МАЛЮВАННЯ КОЛЕСА ───────────────────────────────────────────────
// Кеш завантажених зображень
const _mellImgCache = {};

function loadSegImg(src) {
  return new Promise(resolve => {
    if (_mellImgCache[src]) { resolve(_mellImgCache[src]); return; }
    const img = new Image();
    img.onload  = () => { _mellImgCache[src] = img; resolve(img); };
    img.onerror = () => resolve(null);
    img.src = src;
  });
}

async function preloadWheelImages(segments) {
  await Promise.all(segments.map(seg => seg.visual?.img ? loadSegImg(seg.visual.img) : Promise.resolve()));
}
...
// ══════════════════════════════════════════════════════════════════
let _mellSpring = {
  active:    false,   // зараз тягнемо?
  startY:    0,       // де почали тягнути
  power:     0,       // 0..1
  spinning:  false,   // крутиться зараз?
  rotation:  0,       // поточний кут колеса
  animId:    null,    // requestAnimationFrame id
  segments:  [],
};

function _mellSpringPull(e) {
  if (_mellSpring.spinning || !_mellSpring.active) return;
  const clientY = e.touches ? e.touches[0].clientY : e.clientY;
  const dy      = clientY - _mellSpring.startY;
  // Чим більше тягнемо вниз — тим більша сила (0..1), максимум 120px
  _mellSpring.power = Math.max(0, Math.min(1, dy / 120));
  _updateSpringUI();
}

function _mellSpringRelease() {
  if (!_mellSpring.active || _mellSpring.spinning) return;
  _mellSpring.active = false;
  document.removeEventListener("mousemove",  _mellSpringPull);
  document.removeEventListener("mouseup",    _mellSpringRelease);
  document.removeEventListener("touchmove",  _mellSpringPull);
  document.removeEventListener("touchend",   _mellSpringRelease);

  const power = _mellSpring.power;
  _mellSpring.power = 0;
  _updateSpringUI();

  if (power > 0.05) {
    // Запускаємо спін з потужністю
    _startMellWheelSpin(power);
  }
}

function _updateSpringUI() {
  const fill  = document.getElementById("mell-spring-fill");
  const hint  = document.getElementById("mell-spring-hint");
  const canvas = document.getElementById("mell-wheel-canvas");
  if (!fill) return;
  const p = _mellSpring.power;
  fill.style.width = (p * 100) + "%";

  if (canvas) {
    canvas.classList.toggle("charged", p > 0.3);
  }
...
function _attachSpringEvents(canvas) {
  if (!canvas) return;
  canvas.addEventListener("mousedown", e => {
    if (_mellSpring.spinning) return;
    _mellSpring.active = true;
    _mellSpring.startY = e.clientY;
    _mellSpring.power  = 0;
    _updateSpringUI();
    document.addEventListener("mousemove", _mellSpringPull);
    document.addEventListener("mouseup",   _mellSpringRelease);
  });
  canvas.addEventListener("touchstart", e => {
    if (_mellSpring.spinning) return;
    _mellSpring.active = true;
    _mellSpring.startY = e.touches[0].clientY;
    _mellSpring.power  = 0;
    _updateSpringUI();
    document.addEventListener("touchmove",  _mellSpringPull, { passive: true });
    document.addEventListener("touchend",   _mellSpringRelease);
  }, { passive: true });
}

// ── ЗАПУСК АНІМАЦІЇ КОЛЕСА ────────────────────────────────────────

// ── КІНЕЦЬ СПІНУ ──────────────────────────────────────────────────

function _mellFinish(prize) {
  _mellSpring.spinning = false;
  const canvas = document.getElementById("mell-wheel-canvas");
  if (canvas) canvas.classList.remove("spinning");

  // Оновлюємо лічильник МеллКоінс
  const mellCoinsDisplay = document.getElementById("mellcoins-display");
  if (mellCoinsDisplay) mellCoinsDisplay.textContent = gameState.mellCoins || 0;

  // Показуємо результат inline
  const resultEl = document.getElementById("mell-spin-result-inline");
  if (resultEl) {
    let color = "#ffe066";
    if (prize.type === "item") {
    ...
    resultEl.style.background  = color + "18";
    resultEl.innerHTML = `🎉 ${prize.label}`;
    setTimeout(() => {
...
function _setSpinBtnDisabled(disabled) {
  const btn = document.getElementById("mell-spin-inline-btn");
  if (!btn) return;
  btn.disabled = disabled || (gameState.mellCoins || 0) < MELL_SPIN_COST;
  if (!disabled && (gameState.mellCoins || 0) >= MELL_SPIN_COST) {
    btn.textContent = "🎰 Крутити (" + MELL_SPIN_COST + " 🪙)";
  } else if (disabled) {
    btn.textContent = "⏳ Крутиться...";
  } else {
    btn.textContent = "❌ Мало МеллКоінс";
  }
}
...
// ── МЕЛЛКРАФТ СТАН ─────────────────────────
let _mellGlobalUnsub = null;
let _mellGlobalData  = { totalHp: 0, claimedLevels: [] };
let _mellCraftSelected = [];

// ── МЕЛЛКРАФТ КРАФТ ФУНКЦІЇ ─────────────────

function mellRenderSlots() {
  const slots = document.getElementById("mellcraft-slots");
  const btn   = document.getElementById("mellcraft-btn");
  if (!slots) return;

  const rarities = [...new Set(_mellCraftSelected.map(i => i.rarity).filter(Boolean))];
  const sameRarity = rarities.length === 1;

  slots.innerHTML =
    _mellCraftSelected.map((item, i) => {
      const r = item.rarity ? RARITIES[item.rarity] : null;
      const color = r ? r.color : "#888";
      return `<div class="craft-slot filled" style="border-color:${color}" onclick="mellRemoveItem(${i})">
        <img src="${item.img || 'img/placeholder.png'}" onerror="this.src='img/placeholder.png'">
        <div style="font-size:9px;color:${color};">${r?.name || ''}</div>
        <div style="font-size:9px;color:#aaa;">✕</div>
      </div>`;
    }).join("") +
    Array(Math.max(0, 5 - _mellCraftSelected.length))
      .fill('<div class="craft-slot empty">+</div>').join("");

  if (btn) btn.disabled = _mellCraftSelected.length !== 5 || !sameRarity;

  const info = document.getElementById("mellcraft-info");
  if (!info) return;
  if (_mellCraftSelected.length === 5 && sameRarity) {
    const rarity = rarities[0];
    const coinsData = MELL_CRAFT_COINS[rarity] || MELL_CRAFT_COINS.common;
    info.innerHTML = `<div style="background:var(--bg-card2);border:1px solid var(--border);border-radius:8px;padding:8px;font-size:12px;text-align:center;">
      +<b style="color:#ffe066;">${coinsData.base}–${coinsData.premium} МеллКоінс</b> та
      +<b style="color:#5ddb8a;">${MELL_CRAFT_HP} МеллХП</b>
    </div>`;
  } else if (!sameRarity && _mellCraftSelected.length > 1) {
    info.innerHTML = '<div style="color:#e74c3c;font-size:12px;text-align:center;">⚠️ Тільки однакова рідкість!</div>';
  } else {
    info.innerHTML = `<div style="color:var(--text-muted);font-size:12px;text-align:center;">Вибрано ${_mellCraftSelected.length} / 5</div>`;
  }
}

function mellRenderPicker() {
  const picker = document.getElementById("mellcraft-picker");
  if (!picker) return;

  const currentRarity = _mellCraftSelected.length > 0 ? _mellCraftSelected[0].rarity : null;
  const mellItems = (gameState.inventory || []).filter(i =>
    i.type === "item" &&
    MELLCRAFT_MELL_ITEMS.includes(i.itemId || "") &&
    !_lockedItems.has(i.id) &&
    !_mellCraftSelected.find(s => s.id === i.id)
  );

  const filtered = currentRarity ? mellItems.filter(i => i.rarity === currentRarity) : mellItems;

  if (!filtered.length) {
    picker.innerHTML = '<div class="empty-state">Немає предметів Меллстрой' +
      (currentRarity ? ' рідкості ' + (RARITIES[currentRarity]?.name || currentRarity) : '') + '</div>';
    return;
  }

  picker.innerHTML = filtered.map(item => {
    const r = item.rarity ? RARITIES[item.rarity] : null;
    const dim = currentRarity && item.rarity !== currentRarity;
    return `<div class="craft-pick-item${dim ? ' craft-dim' : ''}" onclick="${dim ? '' : `mellAddItem('${item.id}')`}"
      style="border-left:3px solid ${r ? r.color : '#888'}">
      <img src="${item.img || 'img/placeholder.png'}" onerror="this.src='img/placeholder.png'">
      <span>${item.name}</span>
      ${r ? `<span style="color:${r.color};font-size:11px;">${r.name}</span>` : ''}
    </div>`;
...
function mellAddItem(itemId) {
  if (_mellCraftSelected.length >= 5) return;
  const item = (gameState.inventory || []).find(i => i.id === itemId);
  if (!item) return;
  if (_mellCraftSelected.length > 0 && _mellCraftSelected[0].rarity !== item.rarity) {
    showToast("Тільки однакова рідкість!", "error"); return;
  }
  _mellCraftSelected.push(item);
  mellRenderSlots();
  mellRenderPicker();
}

function mellRemoveItem(index) {
  _mellCraftSelected.splice(index, 1);
  mellRenderSlots();
  mellRenderPicker();
}

async function doMellCraftAction() {
  if (_mellCraftSelected.length !== 5) return;
  const rarities = [...new Set(_mellCraftSelected.map(i => i.rarity).filter(Boolean))];
  if (rarities.length !== 1) { showToast("Всі предмети мають бути однієї рідкості!", "error"); return; }

  const btn = document.getElementById("mellcraft-btn");
  if (btn) { btn.disabled = true; btn.textContent = "⏳ Крафтимо..."; }

  try {
    const success = Math.random() < 0.5;
    const rarity = rarities[0];
    const ro = ["common","exceptional","epic","legendary","secret","special"];
    const nextRarity = ro[Math.min(ro.indexOf(rarity) + 1, ro.length - 1)];

    _mellCraftSelected.forEach(sel => {
      const i = gameState.inventory.findIndex(x => x.id === sel.id);
      if (i !== -1) gameState.inventory.splice(i, 1);
    });
    ...
    if (!success) {
      _mellCraftSelected = [];
      await saveData();
      mellRenderSlots(); mellRenderPicker();
      openModal('<div style="text-align:center;border:2px solid #e74c3c;border-radius:12px;padding:24px;">' +
        '<div style="font-size:48px;">💥</div>' +
        '<div style="font-size:20px;font-weight:700;color:#e74c3c;margin:8px 0;">Крафт провалився!</div>' +
        '<div style="color:var(--text-muted);font-size:14px;margin-bottom:16px;">Всі 5 предметів зникли...</div>' +
        '<button class="btn-primary" onclick="closeModal()" style="width:100%;">Зрозуміло</button></div>');
      return;
    }

    const { quality, collection, premium } = calcCraftAttributes(_mellCraftSelected);
    const pool = Object.values(CASES).flatMap(c => c.items.filter(i => i.rarity === nextRarity && MELLCRAFT_MELL_ITEMS.includes(i.id)));
    const fallback = Object.values(CASES).flatMap(c => c.items.filter(i => i.rarity === nextRarity));
    const allPool = pool.length ? pool : fallback;
    const picked = allPool.length ? allPool[Math.floor(Math.random() * allPool.length)] : null;
    ...
    const newItem = {
      ...
      name: picked ? picked.name : "Крафтовий предмет",
      img: picked ? picked.img : "img/items/placeholder.png",
      rarity: nextRarity, collection: "mellstroy",
      quality: quality || rollQuality(), premium: !!premium,
      fromCase: "mellcraft", fromCaseName: "МеллКрафт",
      source: "mellcraft",
      obtainedBy: currentUser?.username || "?",
      obtainedAt: Date.now(),
    };
    ...
    const craftResult = await submitMellCraft(currentUser.uid, currentUser.username, newItem, gameState);
    ...
    const coinsEl = document.getElementById("mellcoins-display");
    if (coinsEl) coinsEl.textContent = gameState.mellCoins || 0;

    _mellCraftSelected = [];
    await bpHookCraft(1);   
    await bpHookMellCoins(craftResult.coinsEarned);
    renderInventory();
    mellRenderSlots(); mellRenderPicker();

    const r = RARITIES[nextRarity];
    openModal(`<div style="text-align:center;border:2px solid ${r.color};border-radius:12px;padding:24px;background:${r.color}18;">
      <div style="font-size:18px;margin-bottom:8px;">⚗️ МеллКрафт успішний!</div>
      <img src="${newItem.img}" style="width:80px;height:80px;object-fit:contain;display:block;margin:12px auto;">
      <div style="font-weight:700;">${newItem.name}</div>
      <div style="color:${r.color};">${r.name}</div>
      <div style="color:#888;font-size:12px;">${newItem.quality}</div>
      ${newItem.premium ? '<div style="color:#FFD700;">⭐ ПРЕМІУМ</div>' : ''}
      <div style="color:#ffe066;font-size:13px;margin-top:8px;">+${craftResult.coinsEarned} 🪙 МеллКоінс</div>
      <div style="color:#5ddb8a;font-size:13px;">+${MELL_CRAFT_HP} МеллХП</div>
      <button class="btn-primary" onclick="closeModal()" style="margin-top:16px;width:100%;">Забрати!</button>
    </div>`);

    if (craftResult.globalRewardToGive) {
      setTimeout(() => _giveMellGlobalReward(craftResult.globalRewardToGive), 1800);
    }

  } catch(e) {
    showToast("Помилка: " + e.message, "error");
    if (btn) { btn.disabled = false; btn.textContent = "⚗️ Крафтити"; }
  }
}

async function _giveMellGlobalReward(reward) {
  try {
    const snap = await getDoc(doc(db, "users", currentUser.uid));
    if (!snap.exists()) return;
    const inv = [...(snap.data().inventory || [])];

    if (reward.type === "case" || reward.type === "case+coins") {
      const caseData = CASES[reward.caseId];
      inv.push({
        id: generateId(), type: "case", caseId: reward.caseId,
        name: caseData?.name || reward.caseId,
        img: caseData?.img || "img/placeholder.png",
        fromCaseName: "МеллХП Нагорода",
        source: "mellhp_reward",
        obtainedBy: currentUser?.username || "?",
        obtainedAt: Date.now(),
      });
      ...
      if (reward.type === "case+coins" && reward.coins) {
        const newCoins = (gameState.mellCoins || 0) + reward.coins;
        await updateDoc(doc(db, "users", currentUser.uid), { mellCoins: newCoins });
        gameState.mellCoins = newCoins;
        const coinsEl = document.getElementById("mellcoins-display");
        if (coinsEl) coinsEl.textContent = newCoins;
      }

      showToast("🎁 Глобальна нагорода: " + reward.label + "!", "success");

    } else if (reward.type === "medal") {
      inv.push({
        id: generateId(), type: "item", itemId: reward.medalId,
        name: "Медаль «МеллстройКрафт 2026»",
        img: "img/items/placeholder.png",
        rarity: "special", collection: "mellstroy",
        quality: "Прямо з цеху", premium: true,
        fromCase: "mellhp_reward", fromCaseName: "МеллХП Нагорода",
        source: "mellhp_reward",
        obtainedBy: currentUser?.username || "?",
        obtainedAt: Date.now(),
      });
      ...
      gameState.inventory = inv;
      renderInventory();
      showToast("🏅 Ти отримав медаль МеллстройКрафт 2026!", "success");
    }
  } catch(e) {
    console.error("_giveMellGlobalReward error:", e);
    showToast("Помилка видачі нагороди: " + e.message, "error");
  }
}

function injectMellSpinStyles() {
  if (document.getElementById("mellspin-styles")) return;
  const s = document.createElement("style");
  s.id = "mellspin-styles";
  s.textContent = `
    .mell-spin-row {
      display: flex; justify-content: space-between; align-items: center;
      padding: 6px 0; border-bottom: 1px solid var(--border); font-size: 13px;
    }
    .mell-spin-row:last-child { border-bottom: none; }
    .mell-spin-label { color: var(--text); }
    .mell-spin-pct   { font-weight: 700; color: #ffe066; }
  `;
  document.head.appendChild(s);
}

function openMellSpinModal() {
  injectMellSpinStyles();

  if (!MELL_SPIN_TABLE || !MELL_SPIN_TABLE.length) {
    openModal(
      '<h2 class="modal-title">📊 Шанси колеса</h2>' +
      '<div style="color:var(--text-muted);text-align:center;padding:20px;">Таблиця не завантажена</div>' +
      '<button class="btn-primary btn-full" onclick="closeModal()">Закрити</button>'
    );
    return;
  }

  const totalW = MELL_SPIN_TABLE.reduce((s, x) => s + (x.weight || 0), 0);
  const rows = MELL_SPIN_TABLE.map(e => {
    const pct = totalW > 0 ? ((e.weight / totalW) * 100).toFixed(1) : "0.0";
    return `<div class="mell-spin-row">
      <span class="mell-spin-label">${e.label || e.itemId || e.caseId || "?"}</span>
      <span class="mell-spin-pct">${pct}%</span>
    </div>`;
  }).join("");
  ...
  openModal(
    ...
    <div style="color:var(--text-muted);font-size:12px;text-align:center;margin-bottom:16px;">
      Вартість: <b>${MELL_SPIN_COST} МеллКоінс</b> за кручення
    </div>
    <button class="btn-primary btn-full" onclick="closeModal()">Закрити</button>`
  );
}
...
window.adminMellCraftPanel        = adminMellCraftPanel;
window.adminConfirmResetGlobalMell = adminConfirmResetGlobalMell;
window.adminConfirmResetMellUser  = adminConfirmResetMellUser;

window.renderPromoPage    = renderPromoPage;
window.renderAdminPromoPanel = renderAdminPromoPanel;

window.adminGiveMellCoins     = adminGiveMellCoins;
window.adminConfirmMellCoins  = adminConfirmMellCoins;
...
// МеллКрафт
window.renderMellCraft            = renderMellCraft;
window.mellAddItem                = mellAddItem;
window.mellRemoveItem             = mellRemoveItem;
window.doMellCraftAction          = doMellCraftAction;
window._startMellWheelSpin        = _startMellWheelSpin;
window.buildMellWheelSegments     = buildMellWheelSegments;
window.drawWheel                  = drawWheel;
window.drawArrow                  = drawArrow;
window.openMellSpinModal          = openMellSpinModal;
window._mellSpring = _mellSpring;
window._giveMellGlobalReward = _giveMellGlobalReward;
